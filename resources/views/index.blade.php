            ...
            <div class="container mx-auto flex items-center">
                ...
                <div class="flex w-1/2 pl-4 text-sm">
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        <li class="mr-2">
                            <a class="inline-block py-2 px-2 text-white no-underline hover:underline" href="{{url('blog')}}">BLOG</a>
                        </li>
                        <li class="mr-2">
        ...
        <div class="bg-gray-200 w-full text-xl md:text-2xl text-gray-800 leading-normal rounded-t">
                    ...
                    <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                        ...
                        <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                            <div class="flex items-center justify-between">
                                <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="{{$posts[0]->user->name}}" src="http://i.pravatar.cc/300" alt="Avatar of Author">
                                <p class="text-gray-600 text-xs md:text-sm">{{$posts[0]->user->name}}</p>
                                <p class="text-gray-600 text-xs md:text-sm">{{$posts[0]->read_time}} MIN READ</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex flex-wrap justify-between pt-12 -mx-6">
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-lg p-6">
                        <div class="flex items-center justify-between">
                            <img class="w-8 h-8 rounded-full mr-4 avatar" data-tippy-content="{{$posts[1]->user->name}}" src="http://i.pravatar.cc/300" alt="Avatar of Author">
                            <p class="text-gray-600 text-xs md:text-sm">{{$posts[1]->user->name}}</p>
                            <p class="text-gray-600 text-xs md:text-sm">{{$posts[1]->read_time}} MIN READ</p>
                        </div>
                    </div>
                </div>
